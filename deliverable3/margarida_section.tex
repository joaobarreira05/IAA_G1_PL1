...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.48\textwidth]{../tuning_results/if_heatmap.png}
  \includegraphics[width=0.48\textwidth]{../tuning_results/if_contamination_effect.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{../tuning_results/ocsvm_heatmap.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.48\textwidth]{../tuning_results/lof_heatmap.png}
  \includegraphics[width=0.48\textwidth]{../tuning_results/lof_neighbors_effect.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{../tuning_results/baseline_vs_best.png}
